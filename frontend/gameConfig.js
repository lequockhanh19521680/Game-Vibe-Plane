...
const GAME_CONFIG = {
  ...
  // =============================================================================
  // TRANSLATION STRINGS (Mặc định: Tiếng Anh)
  // =============================================================================
  translations: {
    en: {
      "level.levelUp": "LEVEL {level} REACHED!",
      "event.decoyPowerUp": "Decoy Power-up Deployed!",
      "event.chaosMode": "CHAOS MODE ACTIVATED!",
      "event.asteroidShower": "Asteroid Shower!",
      "event.missileIncoming": "Missile Incoming!",
      "event.missileBarrage": "Missile Barrage Incoming!",
      "event.asteroidCircle": "Asteroid Circle Formation!",
      "event.laserGrid": "Laser Grid!",
      "event.blackHoleChain": "Black Hole Chain!",
      "event.shieldGenerator": "Shield Generator Deployed!",
      "event.mineFieldDetonation": "⚠️ Mine Field Detonation! ⚠️",
      "event.wormholePortal": "Wormhole Opened!",
      "event.freezeZone": "❄️ FREEZE ZONES IMMINENT ❄️",
      "event.magneticStormIncoming": "⚠️ MAGNETIC STORM INCOMING! ⚠️ (3s)",
      "event.magneticStormActive": "⚡ MAGNETIC STORM ACTIVE ⚡",
      "event.asteroidBelt": "Asteroid Belt!",
      "event.plasmaInferno": "Plasma Inferno Incoming!",
      "event.plasmaUnleashed": "🔥 PLASMA INFERNO UNLEASHED 🔥",
      "event.crystalStorm": "Cosmic Crystal Storm!",
      "event.quantumPortal": "Quantum Portal Pair!",
      "event.gravityWells": "Gravity Well Field!",
      "event.meteorBombardment": "⚠️ METEOR BOMBARDMENT IMMINENT ⚠️",
      "event.voidRifts": "⚠️ Void Rifts Detected ⚠️",
      "event.lightningStorm": "⚡ THUNDER SHIELD! ⚡",
      "event.difficultySpike": "Difficulty Spike!",
    },
    // Vietnamese translation for all event and level texts (Nếu có)
    vn: {
      "level.levelUp": "ĐẠT CẤP ĐỘ {level}!",
      "event.decoyPowerUp": "Kích hoạt Mồi Nhử!",
      "event.chaosMode": "CHẾ ĐỘ HỖN LOẠN KÍCH HOẠT!",
      "event.asteroidShower": "Mưa Thiên Thạch!",
      "event.missileIncoming": "Tên Lửa Đang Tới!",
      "event.missileBarrage": "Loạt Tên Lửa Đang Tới!",
      "event.asteroidCircle": "Vòng Tròn Thiên Thạch!",
      "event.laserGrid": "Lưới Laser!",
      "event.blackHoleChain": "Chuỗi Hố Đen!",
      "event.shieldGenerator": "Máy Phát Khiên Đã Triển Khai!",
      "event.mineFieldDetonation": "⚠️ Mìn Laser Kích Nổ! ⚠️",
      "event.wormholePortal": "Cổng Dịch Chuyển Mở!",
      "event.freezeZone": "❄️ VÙNG ĐÓNG BĂNG SẮP TỚI ❄️",
      "event.magneticStormIncoming": "⚠️ BÃO TỪ TRƯỜNG ĐANG TỚI! ⚠️ (3s)",
      "event.magneticStormActive": "⚡ BÃO TỪ TRƯỜNG KÍCH HOẠT ⚡",
      "event.asteroidBelt": "Vành Đai Thiên Thạch!",
      "event.plasmaInferno": "Lò Lửa Plasma Đang Tới!",
      "event.plasmaUnleashed": "🔥 LÒ LỬA PLASMA BÙNG PHÁT 🔥",
      "event.crystalStorm": "Bão Tinh Thể Vũ Trụ!",
      "event.quantumPortal": "Cặp Cổng Lượng Tử!",
      "event.gravityWells": "Trường Giếng Trọng Lực!",
      "event.meteorBombardment": "⚠️ BÃO SAO BĂNG ĐANG TỚI ⚠️",
      "event.voidRifts": "⚠️ Vết Nứt Hư Không Được Phát Hiện ⚠️",
      "event.lightningStorm": "⚡ KHIÊN SẤM SÉT! ⚡",
      "event.difficultySpike": "Độ Khó Tăng Đột Biến!",
    },
  },
};
